...
# 13. Даден е CSV фајл, да се исфилтрират сите купувачи според pre_order  и на истите да се зголеми цената за 15%  и да се зачуваат во нов txt file.
awk '$12 == "pre_order" && $6 = $6 * 1.15 {print} file.csv > file.txt
