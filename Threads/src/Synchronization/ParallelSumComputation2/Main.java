package Synchronization.ParallelSumComputation2;
...
//Потребно е да се пресмета вкупниот збир на сите негативни броеви во низата.
//Барања: Да се креираат 10 нишки (SumThread). Секоја нишка треба да обработува подниза со еднаква должина.
//Секоја нишка локално да го пресметува збирот на негативните броеви во својата подниза.
...
class NegativeSum {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // DO NOT CHANGE
        System.out.println("The total sum of negative numbers is: " + totalSum);
    }
    ...
    static class SumThread implements Runnable {
        ...
        public void run() {
            ...
            for (int num : this.arr) {
                // TODO: провери дали бројот е негативен и додај го на localSum
                if (num < 0) {
    ...
    static class NumberGenerator {
        ...
        static final int RANDOM_BOUND = 200;

        public int nextInt() {
            return random.nextInt(RANDOM_BOUND) - 100; // генерира броеви од -100 до 100
        }
    }
    ...
    static class ArrayGenerator {
        ...
        static int[] generate(int length) {
            ...
            for (int i = 0; i < length; i++) {
                array[i] = NegativeSum.random.nextInt();
            }
